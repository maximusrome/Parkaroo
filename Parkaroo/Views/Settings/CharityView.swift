    ...
    var body: some View {
        ScrollView {
            VStack(alignment: .leading) {
                ...
                Text("is a reputable organization that does great work for all New Yorkers. New York Care's organizes food drives, clothing deliveries, tutoring, street clean up, park beautification, and more.  ")
                Text("About Us")
                    .bold()
                    .font(.title)
                    .padding(.vertical)
                Text("Hello, my name is Max, I am 15 years old and I created this app becuase my family was frustrated with the search for on-street parking in NYC. After school I learned how to code and began working on Parkaroo. After eight months we launched version 1.0.\n\nI hope this helps your search for parking, I hope you appreciate our dedication to charity and I hope you feel good about supporting a young entrepreneur.")
                Spacer()
            }.padding()
