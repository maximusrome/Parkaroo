...
struct GiveConfirmView2_Previews: PreviewProvider {
    @State static var presentView: Bool = false
    @State static var showConfirmView: Bool?
    static var previews: some View {
        GiveConfirmView2(presentRatingView: $presentView, showConfirmView: $showConfirmView)
